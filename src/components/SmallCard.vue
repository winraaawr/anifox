  ...
  <RouterLink :to="link" class="group">
    <div class="flex flex-col">
      ...
      >
        <img
          :src="poster"
          class="h-[230px] w-full object-cover rounded-t-md"
        />
        <div
          class="py-1.5 px-1 w-full flex flex-row items-center justify-between space-x-2 bg-gray-800 rounded-b-md"
        >
          ...
          <span
            v-if="rating"
            class="flex flex-row text-green-500 justify-center items-center text-[10px]"
          >
